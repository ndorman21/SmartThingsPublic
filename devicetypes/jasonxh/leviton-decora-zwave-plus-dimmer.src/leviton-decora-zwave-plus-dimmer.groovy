 ...
 */
metadata {
    definition (name: "Leviton Decora Z-Wave Plus Dimmer", namespace: "jasonxh", author: "Hao Xia", ocfDeviceType: "oic.d.light") {
        capability "Actuator"
    ...
    preferences {
        ...
        input name: "indicatorStatusPref", type: "enum", title: "Indicator LED is lit",
                options: ["When switch is off", "When switch is on", "Never"],
                displayDuringSetup: false, required: false
    }
}
...
def configure() {
    ...
    switch (indicatorStatusPref) {
        case "When switch is off": commands.addAll(indicatorWhenOff()); break
